...
//   {title:"WEEKEND TRIPS",url:"https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_1.0/v1/attachments/generic_asset/asset/ae11e2d45410b0eded7fba0e46b09dbd-1598561917003/wordpress-2x.png"},
//   {title:"WORKCATIONS STAYS",url:"https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_1.0/v1/attachments/generic_asset/asset/055f758c1f5b3a1ab38c047dce553860-1598561741669/voiceover-2x.png"},
//   {title:"ADVENTURE COURSES",url:"https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_1.0/v1/attachments/generic_asset/asset/055f758c1f5b3a1ab38c047dce553860-1598561741663/animated-explainer-2x.png"},
//   {title:"CUSTOMISED TRIPS",url:"https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_1.0/v1/attachments/generic_asset/asset/055f758c1f5b3a1ab38c047dce553860-1598561741667/social-2x.png"},
//   {title:"CORPORATE TRIPS",url:"https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_1.0/v1/attachments/generic_asset/asset/055f758c1f5b3a1ab38c047dce553860-1598561741668/seo-2x.png"},
// ]
...
//     <div
//       className={className}
//       style={{ ...style, display: "block", border:"none", borderRadius:"50%", background: "black" }}
//       onClick={onClick}
//     />
//   );
// }
...
//         <h2 className="text-5xl font-bold  sm:text-4xl tracking-normal">Trending Gigs</h2>
//               <p className="text-xl text-gray-500 mt-4">
//                 Millons of people are use <b>EtherX</b> to turn their ideas into reality.
//               </p>
//         </div>

//       <Slider {...settings}  className="flex ml-11 pl-11 w-[93%] mb-16">
//         {data.map((item, index) => {
//           return (
//             <div key={index} className="my-5 w-[254] h-[345]">
